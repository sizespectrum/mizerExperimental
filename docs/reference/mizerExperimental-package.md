...
This is an extension package for the [mizer
package](https://sizespectrum.org/mizer/) that contains additional
features contributed by the mizer community. These features can then be
further improved while being used by the community. Once matured,
...
- <https://github.com/sizespectrum/mizerExperimental>
